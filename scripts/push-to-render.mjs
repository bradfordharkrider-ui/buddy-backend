...
const FILES = ['robinhood-snapshot.json', 'market-snapshot.json', 'fundamentals-snapshot.json', 'webauthn-credentials.json', 'outlook-token-cache.json', 'google-token.json'];
